...
class MainApp(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        self.fileSelector.SetMinSize((170,600))
        openButton = wx.Button(self,-1,label="Open", size=(85,20))
        saveButton = wx.Button(self,-1,label="Save")		
        openButton.Bind(wx.EVT_BUTTON, self.onOpen)
        saveButton.Bind(wx.EVT_BUTTON, self.onSave)
        searchBox = wx.TextCtrl(self)
		
        box.Add(searchBox, (0,0), (1,2), wx.EXPAND)
        box.Add(openButton, (1,0), (1,1), wx.EXPAND)
        box.Add(saveButton, (1,1), (1,1), wx.EXPAND)
        box.Add(self.fileSelector, (2,0), (1,2), wx.EXPAND)
        box.Add(self.tree, (0,2), (3,1), wx.EXPAND)
        box.Add(self.sheet1, (0,3), (3,1) ,wx.EXPAND)
